...
namespace WorkerDronesMod
{
    public static class RefuelMadnessUtility
    {
        ...
        public static List<string> CalculateConsumptionPlan(Pawn android, float missingOil)
        {
            ...
            parts.RemoveAll(p => p.def.defName.Equals("Ribcage", System.StringComparison.OrdinalIgnoreCase));
            if (parts.Count > 1)
                parts.RemoveAll(p => p.def.defName.Equals("Torso", System.StringComparison.OrdinalIgnoreCase));
