...
namespace WorkerDronesMod
{
    public static class HeatUtil
    {
        ...
        public static float CalculateAndApplySolarHeatGain(Pawn pawn, SolverGeneExtension ext)
        {
            ...
            // Sunlight heat gain (with ambient multiplier)
        ...
        /// </summary>
        public static float HeatAmbientMultiplier(float ambientTemp, float scaleFactor = 0.01f)
        {
            // Example: scaleFactor = 0.01 means each degree above/below 21°C changes multiplier by 1%
            return 1f + (ambientTemp - 21f) * scaleFactor;
        }
    }
}
